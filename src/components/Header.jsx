...
import AxipaysLogo from '../media/image/axipays_logo.png';
...
function Header() {
    ...
    const handleSearchInput = (field, value) => {
        ...
        // Filter dropdown results based on input
        if (value.trim() !== "") {
            ...
            <div className={userRole === 'firstUser' ? 'portal-header portal-header-firstuser' : 'portal-header'}>
                ...
                <div className='header-functionality'>
                    <div className='header-notification'>
                        {userRole !== "firstUser" && userRole !== "merchant" && (
                            <div className='ic' onClick={() => openModal('Notification')}>
                                <Icon
                                    name="bell"
                                    width={25}
                                    height={25}
